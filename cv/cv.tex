...
\begin{tabular}{r|p{10cm}}
 \emph{Current} & Devops \& AWS specialist at \href{www.andes.is}{Andes}, Reykjavík \\\textsc{Aug 2020}&\footnotesize{DevOps/Platform engineer \& AWS specialist}\\\multicolumn{2}{c}{} \\
...
Football (soccer), Camping, Hiking, Hunting, Skiing
...
\begin{tabular}{lll}
    \begin{tabular}{@{}l@{}}
        ...
        \phone +354 846 4422 \\
        \href{mailto:bjorng@tempo.io}{bjorng@tempo.io}
    \end{tabular} &
    \begin{tabular}{@{}l@{}}
        ...
        105 Reykjavík, Iceland\\
        \phone +354 510 0611\\
        \href{mailto:seg@trackwell.com}{seg@trackwell.com}
    \end{tabular} &
    \begin{tabular}{@{}l@{}}
        Steinn Guðmundsson\\
        Assistant Professor\\
        ...
        \href{mailto:steinng@hi.is}{steinng@hi.is}
    \end{tabular}
\end{tabular}
%\newpage
